            ...
            <tbody>
              ...
              ?>
                  ...
                  <th>
                    ...
                    <td><a onclick="return confirm('¿Estas Seguro de eliminar este proyecto?')" class="text-danger" href="eliminarproy.php?idsolicitud=<?php echo $dato->idsolicitud; ?>"><i class="bi bi-trash3-fill"></a></td>  
                      <td><a href="asignar.php?idsolicitud=<?php echo $dato->idsolicitud; ?>" class="btn btn-info">Asignar</a></td>
