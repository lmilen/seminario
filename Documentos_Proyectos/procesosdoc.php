...
<body background="imagenes/Fondo.jpg">
    ...
    <?php
            ...
            $contdoc = $_POST["contdoc"];
            $contdoccon = $_POST["contdoccon"];      
...
<br><br>
    ...
    <h3 align="center" style="color: white;">  INFORMACIÓN REGISTRO DOCENTE </h3> 
    <br>
    <div class="container">
        <div class="card-body">
                <div class="form-row">
    ...
    <div class="container" align="center">
        <div class="card booking-card">
            ...
            <?php 
                echo "Gracias Por Registrarte, ".$_POST['nombredoc']." ".$_POST['apellidodoc'].".";
            ?>
            <?php
