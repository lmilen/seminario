...
<body background="imagenes/Fondo.jpg">
    ...
    <?php
            ...
            $apellidoest = $_POST["apellidoest"];
            $progest = $_POST["progest"];
            $falest = $_POST["falest"];
            $codest = $_POST["codest"];
            $correoest = $_POST["correoest"]; 
            $contest = $_POST["contest"];
            $contestcon = $_POST["contestcon"];      
...
<br><br>
    ...
    <h3 align="center" style="color: white;">  INFORMACIÓN REGISTRO ESTUDIANTE </h3> 
    <br>
    <div class="container">
        <div class="card-body">
                <div class="form-row">
                        ...
                        <div class="card booking-card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="alert alert-dark" role="alert"> Apellidos:
                                    <?php echo $apellidoest ?>
                                </div>
                                
                                <div class="alert alert-dark" role="alert"> Programa:
                                    <?php echo $progest ?>
                                </div>
                                
                                <div class="alert alert-dark" role="alert"> Facultad:
                                    <?php echo $falest ?>
                                </div>
    ...
    <div class="container" align="center">
        <div class="card booking-card">
            ...
            <?php 
                echo "Gracias Por Registrarte, ".$_POST['nombreest']." ".$_POST['apellidoest'].".";
            ?>
            <?php
